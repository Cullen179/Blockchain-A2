...
async function MempoolPage() {
  ...
  const highPriorityTxs = mempool.transactions.filter(tx => tx.fee > avgFee).length
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Mempool Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mempool.currentSize}/{mempool.maxSize}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatAmount(totalFees)} BTC</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {mempool.currentSize === 0 ? 'Empty' : 
               utilizationRate > 90 ? 'Nearly Full' : 'Active'}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline">
              {mempool.currentSize} transactions
            </Badge>
          </div>
        </CardHeader>
        <CardContent>
          {mempool.currentSize === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                The mempool is currently empty. New transactions will appear here when submitted.
              </p>
                  ...
                  {mempool.transactions.map((transaction) => (
                    <TableRow key={transaction.id}>
                      ...
                      <TableCell className="text-right">
                        <Badge variant={transaction.fee > avgFee ? "default" : "secondary"}>
                          {formatAmount(transaction.fee)} BTC
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <Badge variant={transaction.fee > avgFee ? "default" : "outline"}>
