...
import { AlertCircle, CheckCircle2, Coins, Hash, Pen, Plus, Send, Trash2, Wallet } from 'lucide-react';
    ...
    <Dialog open={true}>
      ...
      <DialogContent className="max-h-[90vh] max-w-5xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new blockchain transaction by specifying inputs and
            outputs.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormDescription>
                    <div className="mt-2 flex items-center gap-2">
                      <Badge variant="outline" className="font-mono">
                        Balance: {wallet.balance.toLocaleString()} sats (≈{' '}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {field.value > 0 && <>≈ {formatBTC(field.value)} BTC</>}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            {!isBalanceSufficient ? (
              <Alert variant="destructive" className="mt-4">
                ...
                <AlertDescription>
                  Insufficient balance for this transaction. Please adjust the
                  amount or fee.
                </AlertDescription>
              </Alert>
            ) : (
              <UTXOSelector wallet={wallet} totalValue={amount + fee} form={form} />
            )}
            <DialogFooter>
              <DialogClose asChild>
