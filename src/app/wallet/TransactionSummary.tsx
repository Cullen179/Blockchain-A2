        ...
        <div className="mt-4 space-y-4">
          ...
          {transaction.size > 0 && (
            <div className="flex items-center gap-2">
              ...
              <code className="text-sm">{transaction.size} bytes</code>
            </div>
          )}
              ...
              <CardContent className="pt-0">
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      copyToClipboard(transaction.from, 'From Address')
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
              ...
              <CardContent className="pt-0">
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      copyToClipboard(transaction.to, 'To Address')
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
              ...
              {transaction.inputs.map((input, index) => (
                <div key={index} className="space-y-2 rounded-lg border p-3">
                  <div className="flex items-center justify-between">
                    <Badge variant="outline">Input #{index + 1}</Badge>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 pt-0">
              {transaction.outputs.map((output, index) => (
                <div key={index} className="space-y-2 rounded-lg border p-3">
                  <div className="flex items-center justify-between">
                    <Badge variant="outline">Output #{index + 1}</Badge>
                    <Badge variant="secondary">
                      Amount: {formatAmount(output.amount)} BTC
                    </Badge>
                  </div>
